...
<body> 
    ...
    <div id="main">
            <div class="logotipo">
                <img src="https://www.fatecmarilia.edu.br/img/logos/cpssp.png" alt="CPS" width="500" height="150">
        </div>
    </center>
        <div id="content">
            ...
            <p>I - As atividades do Estágio a serem cumpridas pelo (a) Estagiário (a) serão no horário das _____ às ____ horas, com intervalo das refeições das _____ às _____ horas, de 2ª a 6ª feira, perfazendo _________ horas semanais;</p>
            ...
            <p>IV - O (A) Estagiário (a) receberá da concedente durante o período de estágio, uma bolsa no valor de R$ ________ (___________) e auxílio transporte, conforme acordado entre as partes;</p>
            ...
            <p>CLÁUSULA QUARTA. Além das atribuições e responsabilidade previstas no presente Termo de Compromisso de Estágio, caberá à CONCEDENTE:</p>
            ...
            <p>CLÁUSULA QUINTA. Além das atribuições e responsabilidade previstas no presente Termo de Compromisso de Estágio, caberá ao (à) ESTAGIÁRIO (A):</p>
            ...
            <p>CLÁUSULA SEXTA. Caberá à INSTITUIÇÃO DE ENSINO:</p>
            ...
            <p>CLÁUSULA NONA. É assegurado ao (à) Estagiário (a), sempre que o estágio tenha duração igual ou superior a um ano, período de recesso de trinta dias, a ser gozado preferencialmente durante suas férias escolares. E proporcional aos estágios inferiores a um ano. O recesso de que trata esse artigo deverá ser remunerado quando o Estagiário receber bolsa ou outra forma de contraprestação e o auxílio transportes, conforme artigo 13º, § 1º e § 2º da Lei 11.788.</p>

            <p>CLÁUSULA DÉCIMA. Assim, materializado e caracterizado, o presente Estágio, segundo a legislação, não acarretará vínculo empregatício de qualquer natureza entre o (a) Estagiário (a) e a Concedente, nos termos do que dispõem o Artigo 12º da Lei nº 11.788/08.</p>

            <p>CLÁUSULA DÉCIMA PRIMEIRA. As partes elegem o Foro da Comarca de Itapira-SP, com expressa renúncia de outro, por mais privilegiado que seja para dirimir qualquer questão emergente do presente Termo de Compromisso.</p>
